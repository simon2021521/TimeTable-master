...
public class ExamsActivity extends AppCompatActivity {
    ...
    //context is usually an activity and service, this means current activity.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //所在的activity 采用R.layout下的activity_exams进行布局
        initAll();
    }
    //record the state of the current activity.
   //https://blog.csdn.net/jingzhesiye/article/details/23430307
